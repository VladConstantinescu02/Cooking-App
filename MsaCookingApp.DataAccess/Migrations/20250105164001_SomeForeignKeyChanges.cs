...
{
    /// <inheritdoc />
    public partial class SomeForeignKeyChanges : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitName = table.Column<string>(type: "TEXT", maxLength: 250, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientMeasuringUnits", x => x.Id);
                });
            ...
            migrationBuilder.DropIndex("IX_FK_FridgeIngredients_Ingredients_IngredientId1", table: "FridgeIngredients");
            migrationBuilder.DropIndex("IX_FK_Meals_MealTypes_MealTypeId1", table: "Meals");
